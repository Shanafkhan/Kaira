...
export default function Store() {
  return (
    ...
    >
      ...
      {/* Button */}
      <button className="rounded-[55px] py-3 sm:py-4 px-6 sm:px-8 border-2 border-brown font-secondary text-lg sm:text-xl md:text-2xl font-bold text-brown hover:bg-brown hover:text-[#F5EDD9] transition duration-300">
